...
async function searchData() {
    ...
    const url = `https://sheets.googleapis.com/v4/spreadsheets/${1_tiF71t5Fw_8kMN2lRwkeh79yAhmXW_iArezdelO5LI}/values/${대구ME발표팀!A:G}?key=${AIzaSyAaja3hDnEOYASt6x7Uz2M-PY3m1N-RahQ}`;
